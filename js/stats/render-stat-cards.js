...
function renderStatCards(stats){
  ...
  const cards = [
    ...
    { label: 'Лучший месяц', value: stats.bestMonth ? escapeHtml(stats.bestMonth.label) : '—', sub: stats.bestMonth ? fmtNum(stats.bestMonth.sum) + ' дин.' : '' },
    ...
    { label: 'Лучший часовой доход', value: stats.bestHourlyDay ? fmtNum(stats.bestHourlyRate) + ' дин./ч' : '—', sub: stats.bestHourlyDay ? stats.bestHourlyDay.date : '' },
