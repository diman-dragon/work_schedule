...
function buildCharts(stats){
  ...
  charts.earnings = new Chart($('chartEarnings'), {
    type:'bar',
  ...
  charts.weekdayCount = new Chart($('chartWeekdayCount'), {
    type:'bar',
  ...
  charts.weekdayAvg = new Chart($('chartWeekdayAvg'), {
    type:'bar',
  ...
  charts.weekdayEarnings = new Chart($('chartWeekdayEarnings'), {
    type:'bar',
  ...
  charts.weekendSplit = new Chart($('chartWeekendSplit'), {
    type:'doughnut',
  ...
  charts.weeklyTrend = new Chart($('chartWeeklyTrend'), {
    type:'line',
  ...
  charts.shiftTimes = new Chart($('chartShiftTimes'), {
    type:'bar',
  ...
  charts.startHour = new Chart($('chartStartHour'), {
    type:'bar',
  ...
  if(stats.byBus.length){
    charts.byBus = new Chart($('chartByBus'), {
      type:'bar',
    ...
    charts.byBusEarn = new Chart($('chartByBusEarn'), {
      type:'bar',
  ...
  if(stats.byRoute.length){
    charts.byRoute = new Chart($('chartByRoute'), {
      type:'bar',
    ...
    charts.byRouteEarn = new Chart($('chartByRouteEarn'), {
      type:'bar',
